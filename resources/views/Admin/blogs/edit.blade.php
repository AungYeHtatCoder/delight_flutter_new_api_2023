            ...
            <div class="form-body">
             <div class="row">
                <div class="form-group col-12 mb-2">
                    ...
                    <input type="text" id="eventInput2" class="form-control" placeholder="Enter Title" name="title" value="{{ $blog->title }}">
                    @error('title')
                ...
                <textarea name="description" id="desc" cols="30" rows="10" class="form-control" placeholder="Enter Description">{!! $blog->description !!}</textarea>
                @error('description')
                <span class="text-danger">*{{ $message }}</span>
                @enderror
                </div>
